        ...
        <>
            <section className="w-full text-left gap-4 flex flex-col-reverse md:flex-row items-center justify-between md:px-24 mb-10">
                <div className="flex flex-col gap-2 md:w-1/2">
                    ...
                    <a
                        className="mt-4 flex md:w-1/3 cursor-pointer bg-accent text-black items-center justify-center rounded-md gap-2 shadow-lg transition-all duration-200 hover:opacity-75"
